...
if ($isFastUpgrade) {
	...
	if ($system_offline) {
		print  "<p class='darkgreen'>
					<img src='".APP_PATH_IMAGES."tick.png'>
					".$lang['upgrade_023']." $autologout_timer ".$lang['upgrade_024s']."
				</p>";
	} else {
...
if (($configNonEnglish + $projectsNonEnglish) > 0)
{
	...
	if (!empty($languagesUsed))
	{
		...
		".$lang['upgrade_026']."
				<a href='https://redcap.vanderbilt.edu/plugins/redcap_consortium/language_library.php' target='_blank' style='text-decoration:underline;'>".$lang['upgrade_027']."</a>.
				<br><br>
