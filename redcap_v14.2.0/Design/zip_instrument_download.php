...
if (isset($Proj->forms[$_GET['page']]['survey_id']) && isset($Proj->surveys[$Proj->forms[$_GET['page']]['survey_id']]))
{
    ...
    $surveyHeaders = array("title","instructions","offline_instructions","acknowledgement","stop_action_acknowledgement",
        ...
        "pdf_save_to_field","pdf_save_to_event_id","pdf_auto_archive","pdf_econsent_version","pdf_econsent_type","pdf_econsent_firstname_field",
        "pdf_econsent_firstname_event_id","pdf_econsent_lastname_field","pdf_econsent_lastname_event_id","pdf_econsent_dob_field",
        "pdf_econsent_dob_event_id","pdf_econsent_allow_edit","pdf_econsent_signature_field1","pdf_econsent_signature_field2",
        "pdf_econsent_signature_field3","pdf_econsent_signature_field4","pdf_econsent_signature_field5"
    );
...
if ($Proj->project['mycap_enabled'] && isset($myCapProj->tasks[$_GET['page']]['task_id'])) {
    ...
    $taskInfo = \Vanderbilt\REDCap\Classes\MyCap\Task::getAllTasksSettings(PROJECT_ID, $taskId);
