...
if ($dateShiftDates && !$dateShiftSurveyTimestamps) $dateShiftSurveyTimestamps = true;
// For de-id rights, make sure dates are either removed or date shifted
//if (!$dateShiftDates && !$removeDateFields) $removeDateFields = true;
...
// E-Consent citation
$sql = "select 1 from redcap_projects p, redcap_surveys s 
		where s.project_id = p.project_id and s.pdf_auto_archive = '2' and p.project_id = $project_id limit 1";
