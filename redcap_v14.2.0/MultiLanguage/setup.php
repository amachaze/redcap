    ...
    <template data-mlm-template="languages-row">
        <tr data-mlm-language="">
            ...
            <td>
                ...
                <button data-mlm-action="empty-pdf-all" class="btn btn-light btn-sm text-secondary" data-bs-toggle="tooltip" title="<?=RCView::tt_js2('data_export_tool_158')?>">
        ...
        <table class="table table-responsive table-md mlm-fit-content">
            <thead>
                <tr>
                    ...
                    <th scope="col"><?=RCView::tt("global_71") // Export ?></th>
                </tr>
            </thead>
    ...
    <div class="d-none"><!-- Templates -->
        ...
        <template data-mlm-template="forms-row">
            <tr data-mlm-form="" data-mlm-language="">
                ...
                <td class="text-center">
                    <div class="mlm-text-cell text-center">
                        <span class="switch switch-xs" data-mlm-switch="form-active">
                            ...
                            <label for="" data-bs-toggle="tooltip" title="<?=RCView::tt_attr("multilang_81") // Check to enable translations on this data entry instrument ?>"></label>
                        </span>
                    </div>
                </td>
                <td class="remove-when-surveys-off">
                    <div class="mlm-text-cell text-center">
                        <span class="switch switch-xs" data-mlm-switch="survey-active">
                            ...
                            <label for="" data-bs-toggle="tooltip" title="<?=RCView::tt_attr("multilang_82") // Check to enable translations on this survey ?>"></label>
                        </span>
                    </div>
                </td>
                <td>
                ...
                <td class="text-center">
                    <button data-mlm-action="export-single-form" class="btn btn-light btn-xs text-primary hide-when-ref-lang" data-bs-toggle="tooltip" title="<?=RCView::tt_js2('multilang_574')?>">
                        <i class="fa-solid fa-file-arrow-down"></i>
                    </button>
                    <button data-mlm-action="empty-pdf" class="btn btn-light btn-xs text-secondary" data-bs-toggle="tooltip" title="<?=RCView::tt_js2('data_export_tool_158')?>">
                        <i class="fa-solid fa-file-pdf"></i>
                    </button>
                </td>
            </tr>
            ...
            <div data-mlm-field class="mlm-field-block">
                ...
                <div class="mlm-item-translated-indicator">
                    ...
                    <div style="display: inline-block;">
                        <input data-mlm-translation data-mlm-type="field-complete" style="position:relative;top:2.5px;margin-left:3px;" type="checkbox" id="" value="1" data-bs-toggle="tooltip" title="<?=RCView::tt_attr("multilang_86") // Check to mark this field as translated ?>">
                    </div>
