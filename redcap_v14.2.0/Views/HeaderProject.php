...
//Data Logging
if ($user_rights['data_logging'] || $user_rights['user_rights'] == '1') {
	...
	if ($GLOBALS['email_logging_enable_global'] && $user_rights['user_rights'] == '1' && $user_rights['data_logging']) {
		$appsMenu .= RCView::span(array('style'=>'color:#777;margin:0 7px 0 6px;'), $lang['global_43']);
	}
	if ($GLOBALS['email_logging_enable_global'] && $user_rights['user_rights'] == '1') {
...
$externalModulesMenu = "<div class='menubox' style='font-size:11px;color:#444;'></div>";
