...
<tr>
    ...
    <td class="cc_data">
        ...
        <div class="cc_info">
            ...
            <div class="mt-2"><?=(class_exists('Imagick') ? $lang['system_config_810'] : '<div class="text-dangerrc"><i class="fa-solid fa-circle-exclamation font-weight-bold"></i> '.$lang['system_config_811'].'</div>')?></div>
        </div>
    </td>
</tr>
...
<tr>
	...
	<td class="cc_data">
		...
		<span style="margin-left:12px;">
			<?php echo $lang['system_config_317'] ?>
			&nbsp;&nbsp;<button class="jqbuttonmed" onclick="testUrl('<?=Mosio::API_BASE?>','post','');return false;"><?php echo $lang['edit_project_138'] ?></button>
		</span>
		<div class="cc_info">
...
<tr>
	...
	<td class="cc_data">
		...
		<span style="margin-left:12px;">
			<?php echo $lang['system_config_317'] ?>
			&nbsp;&nbsp;<button class="jqbuttonmed" onclick="testUrl('https://api.sendgrid.com/v3','post','');return false;"><?php echo $lang['edit_project_138'] ?></button>
		</span>
		<div class="cc_info">
