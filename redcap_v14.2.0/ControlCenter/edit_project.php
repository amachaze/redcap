...
if (isset($_GET['project']) && isinteger($_GET['project']))
{
	...
	<tr  id="project_language-tr" sq_id="project_language">
		...
		<td class="cc_data">
			...
			<div class="cc_info">
				...
				<a href='https://redcap.vanderbilt.edu/plugins/redcap_consortium/language_library.php' target='_blank' style='text-decoration:underline;'><?=js_escape($lang['upgrade_027'])?></a>.
	...
	<tr  id="fhir_include_email_address_project-tr">
        ...
        <td class="cc_data">
			...
			<? if($disabled) :?>
				<span><small class="text-danger fst-italic">Please note that this option is currently managed at system level in the CDIS settings page</small></span>
			<? endif; ?>
        </td>
    </tr>
	...
	<tr  id="ehr_id-tr">
        ...
        <td class="cc_data">
            ...
            <select class="x-form-text x-form-field" style="" name="ehr_id">
                <option value="" <?= ($element_data['ehr_id'] == $defaultEhrID ) ? "selected" : "" ?>>Default</option>
            ...
            <div class="cc_info">
				...
				<a href="<?= APP_PATH_WEBROOT ?>ControlCenter/ddp_fhir_settings.php">CDIS settings</a>
            </div>
        </td>
    </tr>
