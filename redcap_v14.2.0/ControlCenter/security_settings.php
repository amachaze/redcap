...
<tr  id="auth_meth_global-tr" sq_id="auth_meth_global">
	...
	<td class="cc_data">
		<select class="x-form-text x-form-field" style="max-width:98%;" name="auth_meth_global">
			...
			<option value='oauth2_azure_ad' <?php echo ($element_data['auth_meth_global'] == "oauth2_azure_ad" ? "selected" : "") ?>>Azure AD OAuth2 <?php echo $lang['system_config_251'] ?></option>
            <option value='oauth2_azure_ad_table' <?php echo ($element_data['auth_meth_global'] == "oauth2_azure_ad_table" ? "selected" : "") ?>>Azure AD OAuth2 & <?php echo $lang['system_config_09'] . " " . $lang['system_config_251'] ?></option>
...
<!-- Additional Azure AD OAuth2 Settings -->
<tr>
	<td colspan="2">
		<hr size=1>
		<h4 style="font-size:14px;padding:0 10px;color:#800000;">
			<span style="vertical-align:middle;margin-left:2px;"> <?php echo $lang['system_config_676'] ?></span>
		</h4>
		<div class="cc_info" style="margin: 5px 10px;">
			<?php echo $lang['system_config_681'] ?>
		</div>
	</td>
</tr>
<tr>
	<td class="cc_label"><?php echo $lang['system_config_677'] ?></td>
	<td class="cc_data">
...
<tr>
	<td class="cc_label"><?php echo $lang['system_config_678'] ?></td>
	<td class="cc_data">
...
<tr>
	<td class="cc_label"><?php echo $lang['system_config_765'] ?></td>
	<td class="cc_data">
		...
		<div class="cc_info">
			<?php echo $lang['system_config_764'] ?>
		</div>
	</td>
</tr>
<tr>
	<td class="cc_label">
		<?php echo $lang['system_config_813'] ?>
		<div class="cc_info">
...
<tr>
    <td class="cc_label"><?php echo $lang['global_263'] ?></td>
    <td class="cc_data">
...
<tr>
        ...
        <div class="cc_info" style="margin: 5px 10px;font-weight:normal;">
			...
			<a href="https://redcap.vanderbilt.edu/community/post.php?id=57043" target="_blank" style="text-decoration:underline;"><?php echo $lang['system_config_828'] ?></a><?php echo $lang['system_config_829'] ?>
		</div>
        </td>
</tr>
