...
trait CanNormalizeTimestamp
{
   ...
   * @return string
   */
  private function getGmtTimestamp($timestamp, $format='Y-m-d H:i')
  {
    if(!$timestamp) return '';
   ...
   * @return void
   */
  private function getLocalTimestamp($timestamp, $format='Y-m-d H:i')
  {
    if(!$timestamp) return '';
    $time = strtotime($timestamp);
   ...
   * @return callable
   */
  private function getTimestampCallable($timestamp, $format='Y-m-d H:i')
  {
