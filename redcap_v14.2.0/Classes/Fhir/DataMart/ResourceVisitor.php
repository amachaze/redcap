...
class ResourceVisitor implements ResourceVisitorInterface
{
  ...
  /**
   *
   * @param FhirMappingGroup $mapping
   */
   ...
   */
  function __construct($mappingGroup, $fhirClient=null)
  {
  ...
  public function visitDocumentReference($resource)
  {
    ...
    $data['attachments'] = $resource->saveAttachments($this->fhirClient);
    $data['links'] = $resource->saveLinks($projectID);
