...
class DataMart
{
    ...
    const DATE_RANGE_CATEGORIES = [
        ['name' => 'Allergy Intolerance', 'defaultEnabled' => false],
        ['name' => 'Appointment - Appointments', 'defaultEnabled' => false],
        ['name' => 'Appointment - Scheduled Surgeries', 'defaultEnabled' => false],
        ['name' => 'Condition', 'defaultEnabled' => false],
        ['name' => 'Condition - Dental Finding', 'defaultEnabled' => false],
        ['name' => 'Condition - Genomics', 'defaultEnabled' => false],
        ['name' => 'Condition - Infection', 'defaultEnabled' => false],
        ['name' => 'Condition - Medical History', 'defaultEnabled' => false],
        ['name' => 'Condition - Problems', 'defaultEnabled' => false],
        ['name' => 'Condition - Reason for Visit', 'defaultEnabled' => false],
        ['name' => 'Core Characteristics', 'defaultEnabled' => true],
        ['name' => 'Diagnosis', 'defaultEnabled' => false],
        ['name' => 'Encounter', 'defaultEnabled' => true],
        ['name' => 'Immunization', 'defaultEnabled' => true],
        ['name' => 'Laboratory', 'defaultEnabled' => true],
        ['name' => 'Medications', 'defaultEnabled' => false],
        ['name' => 'Procedure', 'defaultEnabled' => false],
        ['name' => 'SmartData', 'defaultEnabled' => false],
        ['name' => 'Social History', 'defaultEnabled' => false],
        ['name' => 'Vital Signs', 'defaultEnabled' => true],
    ];
