...
class Authentication
{
	...
	static function checkLogout()
	{
		...
		if (isset($_GET['logout']) && $_GET['logout'])
		{
            ...
            if ($auth_meth_global == 'openid_connect' && isset($_SESSION['openid_connect_id_token'])) {
			...
			elseif ($auth_meth_global == 'openid_connect' || $auth_meth_global == 'openid_connect_table') {
                try {
            ...
            elseif ($auth_meth_global == 'oauth2_azure_ad' || $auth_meth_global == 'oauth2_azure_ad_table') {
                $azureParams = [
				...
				$logoutRedirect = $provider->getLogoutUrl(APP_PATH_WEBROOT_FULL);
			}
	...
	private static function authenticateOauth2AzureAD()
	{
		...
		global  $auth_meth_global, $login_logo, $institution, $login_custom_text, $homepage_contact_email, $homepage_contact,
				$openid_provider_url, $openid_provider_name, $lang, $oauth2_azure_ad_client_id, $oauth2_azure_ad_client_secret,
