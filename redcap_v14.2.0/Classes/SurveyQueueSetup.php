    ...
    public function import()
    {
        ...
        foreach ($all_SQS_settings as $settings) {
            try {
                ...
                $settings['condition_surveycomplete_survey_id'] = Survey::getSurveyId($settings['condition_surveycomplete_form_name'] ?? null);
                ...
                if ((empty($survey_id) || !$settings['condition_surveycomplete_survey_id'] || !$settings['condition_surveycomplete_event_id'])) {
                ...
                if (!LogicTester::isValid($settings['condition_logic'])) {
