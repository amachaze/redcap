...
class Form
{
	...
	public static function addHiddenFieldsOtherEvents($record, $event_id, $form, $instance)
	{
		...
		while ($row = db_fetch_assoc($q))
		{
			...
			$row['bl_calc'] = Piping::pipeSpecialTags($row['bl_calc'], PROJECT_ID, $record, $event_id, $instance, null, true, null, $form, false, false, false, true);
     ...
     * @return void
     */
    public static function checkInstallDateFieldExists($projectId)
    {
