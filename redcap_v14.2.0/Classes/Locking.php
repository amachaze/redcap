		...
		print "<div id=\"recordLockPdfConfirmDialog\" class=\"simpleDialog\" data-rc-lang-attrs=\"title=data_entry_476\" title=\"".RCView::tt_js2("data_entry_476")."\">
					...
					<div style='margin:5px;padding:3px;border:1px solid #ccc;'>
						...
						? ("<div class='p-2'>".RCView::tt("data_entry_569")." 
							<button class='btn btn-xs btn-defaultrc ms-2 fs14' style='color:#C00000;' onclick='window.open(\"$pdfUrlReal\", \"_blank\");'><i class='far fa-file-pdf'></i> ".RCView::tt("survey_1364")."</button>
							</div>")
						: ("<object data='$pdfUrl' type='application/pdf' style='width:100%;height:$height;'>
							<iframe id='record_lock_pdf_confirm_iframe' src='$pdfUrl' style='border:none;width:100%;height:$height;'>".RCView::tt("survey_1366")." <a target='_blank' href='$pdfUrlReal'>".RCView::tt("survey_1341")."</a>
							</iframe>
							</object>")
					)."
					</div>
