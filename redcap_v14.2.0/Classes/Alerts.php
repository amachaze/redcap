        ...
        foreach (array_keys(getBracketedFields($logicPipingVars, true, true, false)) as $this_field)
        {
            ...
            if (strpos($this_field, ".") !== false) {
                ...
                if (Piping::containsEventSpecialTags("[$this_event_name]")) {
                    $this_event_name = Piping::pipeSpecialTags("[$this_event_name]", $project_id, $record, $event_id, $repeat_instance, null, false, null, $instrument, false, false, false, true);
                }
...
//            }
    ...
    public function checkAlertsBulk($project_ids=null, $datediffsOnly=false, $alert_ids=array(), $is_dry_run = true)
    {
	...
	function sendNotification($alert_id, $project_id, $record, $event_id, $instrument, $instance=1, $data=array())
	{
		...
		$mail = new Message($project_id, $record, $event_id, $instrument, $instance);
		// Email Addresses
	...
	public function renderSetup()
	{
		...
		addLangToJS(array('alerts_24','alerts_36','alerts_37','alerts_38','docs_72','alerts_39','alerts_40','alerts_41','alerts_42','alerts_43','alerts_44','alerts_45', 'survey_1237',
						  ...
						  'alerts_214','alerts_251','alerts_252', 'alerts_311', 'design_128', 'alerts_309', 'alerts_325', 'alerts_326', 'alerts_327', 'global_19', 'data_import_tool_99',
						  'training_res_46', 'alerts_333', 'alerts_340', 'alerts_332', 'global_27', 'alerts_342', 'alerts_343', 'data_entry_64', 'global_48', 'alerts_351', 'alerts_397',
                          'alerts_398'));
                ...
                <table class="table table-bordered table-hover email_preview_forms_table" id="customizedAlertsPreview" style="display:none;width:100%;table-layout: fixed;">
                    ...
                    foreach ($projectData as $alert_id=>$attr)
                    {
                        ...
                        foreach ($attr as $configKey => $configVal) {
                            ...
                            if ($configKey == 'phone_number_to' && $configVal !== null) {
									...
									<table class="code_modal_table" id="code_modal_table_update">
										...
										<tr class="form-control-custom">
											<td colspan="2" class="align-text-top pt-1">
												...
												<input type="text" name="alert-title" placeholder="add optional title"class="d-inline ms-3" style="font-size:15px;width:500px;" maxlength="100">
											</td>
										</tr>
										<tr class="form-control-custom">
											<td colspan="2">
