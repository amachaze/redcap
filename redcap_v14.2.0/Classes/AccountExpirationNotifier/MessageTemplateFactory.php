...
class MessageTemplateFactory {
     ...
     */
    public function __construct($customUserOnlyText = null, $customUserWithSponsorText = null) {
    ...
    private function getDefaultUserOnlyEmail($user) {
        global $lang;
    ...
    private function getDefaultUserWithSponsorEmail($user) {
