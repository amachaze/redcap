...
if ($mycap_enabled)
{
	...
	$checkList[$stepnum++] = array("header" => "<img src='" . APP_PATH_IMAGES . "mycap_logo_black.png' style='width:24px;position:relative;top:-2px;'> ".$lang['mycap_mobile_app_631'],
		"name" => "mycap",
		"status" => $mycapStatus,
		"text" =>  "{$lang['mycap_mobile_app_632']}
					<div class='chklistbtn'>
						{$lang['setup_45']}&nbsp; <button class='btn btn-defaultrc btn-xs fs13' onclick=\"window.location.href=app_path_webroot+'MyCapMobileApp/index.php?about=1&pid=$project_id';\"><i class='fa-solid fa-mobile-screen-button fs15' style='position:relative;top:1px;'></i> {$lang['mycap_mobile_app_630']}</button>
						{$lang['global_47']}&nbsp;
...
if ($mycap_enabled_global)
{
	...
	$mycapDlgContent = MyCap::getMyCapAboutInstructions() . $appendLongitudinalNotice . $appendAdminOnlyNotice;
...
if ($myCapEnabled) {
    $myCapNote = "<br>".$lang['mycap_mobile_app_707'];
}
...
<div id="customize_project" style="display:none;" title="<?php print js_escape2($lang['setup_104']) ?>">
	...
	<div class="round chklist" style="padding:10px 20px;max-width:900px;">
      ...
      <!-- Display Today/Now button -->
        ...
        <tr>
            <td colspan="2" valign="top" style="margin-left:1.5em;text-indent:-2.2em;padding:10px 5px 10px 40px;">
                <input type="checkbox" id="bypass_branching_erase_field_prompt" name="bypass_branching_erase_field_prompt" <?php if ($bypass_branching_erase_field_prompt) print "checked"; ?>>
                &nbsp;
                <img src='<?=APP_PATH_IMAGES?>arrow_branch_side.png'>
                <b style=""><u><?php echo $lang['project_settings_59'] ?></u></b><br>
                <?php echo $lang['project_settings_63']." ".$lang['project_settings_62'] ?>
            </td>
        </tr>
