...
function fileRepoDeleteFolder(folder_id, file_count)
{
	...
	if (file_count > 0) {
		simpleDialog('<div class="fs14">'+lang.docs_100+'<div class="mt-3">'+lang.docs_99+' <code class="fs15 boldish">'+folderName+'</code></div></div>', lang.docs_101, null, 550);
	} else {
		// Error: Cannot delete folder that still has files in it
		simpleDialog('<div class="fs14">'+lang.docs_98+'<div class="mt-3">'+lang.docs_99+' <code class="fs15 boldish">'+folderName+'</code></div></div>', lang.docs_97, null, 500, null, lang.global_53, "fileRepoDeleteFolderDo("+folder_id+");", lang.global_19);
	}
}
...
{
	var foldername = $('#file-folder-'+folder_id).text();
	simpleDialog('<div class="fs14">'+lang.docs_104+' <code class="fs15 nowrap">'+foldername+'</code>'+lang.questionmark+'<div class="mt-4 mb-2">'+lang.docs_103+'<input id="folder-rename-input" type="text" class="ms-2 x-form-text x-form-field fs14" maxlength="150" style="width:400px;" value="'+htmlspecialchars(foldername)+'"></div></div>', lang.docs_102, null, 600, null, lang.global_53, "fileRepoFolderRenameDo("+folder_id+");", lang.docs_102);
}
	...
	if (recycle_bin == '1') {
		...
		if (pdf_econsent_system_ip) {
			columns = [
				...
				{data: "3", title: lang.survey_437},
				{data: { _: "4.display", sort: "4.sort" }, type: "num", title: lang.survey_1161},
				{data: "5", title: lang.survey_1172},
				{data: "6", title: lang.survey_1221}, // IP address
			...
			columns = [
				...
				{data: { _: "4.display", sort: "4.sort" }, type: "num", title: lang.survey_1161},
				{data: "5", title: lang.survey_1172},
				{data: "6", title: lang.survey_1173},
				{data: "7", title: lang.survey_1174},
				{data: { _: "8.display", sort: "8.sort" }, type: "num", title: lang.docs_78}
			];
		}
