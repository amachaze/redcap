...
function displayFormSaveBtnTooltip() {
	...
	if (super_user_not_impersonator) {
		$('#formSaveTip').append('<div class="mt-2"><button id="auto-fill-btn" class="btn btn-link btn-xs" style="font-size:11px !important;padding:1px 5px !important;margin:0 !important;color:#007bffcc;" onclick="autoFill();"><i class="fs10 fa-solid fa-wand-magic-sparkles"></i> '+lang.global_275+'</button></div>');
	}
