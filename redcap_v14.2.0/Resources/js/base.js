...
function concat_ws() {
	...
	const items = Array.from(args).slice(1);
...
function showToast(title, content, type, delay)
{
	...
	html += '		<button type="button" class="'+fg+' ms-2 mb-1 close" data-dismiss="toast" aria-label="Close"><span aria-hidden="true">&times;</span></button>';
	html += '	</div>';
	if (content) {
