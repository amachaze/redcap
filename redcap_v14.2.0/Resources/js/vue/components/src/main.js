...
window.initTinyMCEglobal = (selector = 'vue-mceditor', compact = false) => {
    ...
    // Set toolbars
    var toolbar1defaults =
        'blocks bold italic underline forecolor backcolor | link | fullscreen'
    var toolbar2defaults =
        'align table pre hr | bullist numlist outdent indent | searchreplace removeformat undo redo code'
