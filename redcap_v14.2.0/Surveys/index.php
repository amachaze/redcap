...
$surveyEnded = (isset($_GET['__endsurvey']) || ($_GET['__page__'] > $totalPages) || (!$question_by_section && $pdf_auto_archive < 2) || $totalPages == 1);
...
$is_econsent_page = $pdf_econsent_system_enabled && $pdf_auto_archive == 2 && $totalPages == $_GET['__page__'];
