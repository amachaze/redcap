...
<div class="container">
    <div class="panel-group searchable" id="accordion">
        <div class="tab-content"><div id="1" class="tabpanel tab-pane fade in active" role="tabpanel"><div class="panel-group searchable" id="accordion-1"><div class="faqHeader">General</div><div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_8_tab_1">What is form display logic? </a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_9_tab_1">Does the order of fields matter when you use field embedding?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_10_tab_1">What happens to ASI's Alerts/Notification and other emails when the system is set to offline?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_11_tab_1">What are Automated Survey Invitations?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_12_tab_1">Do automated survey invitations preclude manual survey invitations?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_13_tab_1">When are automated survey invitations sent out?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_14_tab_1">Is there any tool that can help me figure out how to set up ASI?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_15_tab_1">Can you base ASI on Calendar/Event dates?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_16_tab_1">How can I schedule a survey invitation to go out at a specific time?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_17_tab_1">What mathematical operations can be used in the logic for Automated Survey Invitations?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_18_tab_1">How do I use the datediff function with ASI syntax for conditional logic?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_19_tab_1">If I create a timestamp field, including hours, minutes, and days, can I create an automated survey invitation that will detect how many days it has been since the timestamp?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_20_tab_1">How can I use automated survey invitations to send invitations a specific number of days after a date given by a variable?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_21_tab_1">Is there any way to send a survey prior to a specific date e.g. if a surgery is scheduled 60 days from now and they would want the survey to be sent 14 days prior to that?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_22_tab_1">How do variables included via piping interact with an automated survey invitation?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_23_tab_1">How often does REDCap check to see if Automated Survey Invitations (ASI) are ready to be scheduled?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_24_tab_1">If a survey has already been completed, will the scheduler still send out survey invitations?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_25_tab_1">Do participants with partially completed surveys receive the automated survey invitation reminders?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_26_tab_1">How do you stop survey reminders?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_1_question_27_tab_1">Can you designate a project-level phone number for sending text messages or making voice calls to invite participants to complete surveys?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_6_question_39_tab_2">What is eConsent?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_6_question_40_tab_2">How do I set up the eConsent module in REDCap?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_6_question_41_tab_2">Where are the archived PDFs of my consents stored?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_6_question_42_tab_2">Can anyone alter a consent form after it is submitted with the eConsent framework?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_6_question_43_tab_2">How do I setup a survey confirmation email?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_6_question_44_tab_2">Can I pipe in information from the survey into my confirmation email?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_6_question_45_tab_2">What kind of attachment can I send with a survey confirmation email?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_6_question_46_tab_2">Do the remaining reminders get canceled once a participant fills out a survey?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_6_question_47_tab_2">What happened to the "Preview survey" feature?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_6_question_48_tab_2">How does Twilio interact with REDCap to send calls and SMS messages?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_9_question_12_tab_3">Is it possible to use branching logic to skip an entire form or forms?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#category_9_question_13_tab_3">Is it possible to use branching logic to skip an entire section?</a>
                            </h4>
                        </div>
                    ...
                    </div></div></div><div id="8" class="tabpanel tab-pane fade in " role="tabpanel"><div class="panel-group searchable" id="accordion-8"></div></div><div id="5" class="tabpanel tab-pane fade in " role="tabpanel"><div class="panel-group searchable" id="accordion-5"><div class="faqHeader">Application Tools</div><div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                        ...
                        <div id="category_46_question_5_tab_7" class="panel-collapse collapse">
                            <div class="panel-body">
                                <div><p>Multi-Language Management (MLM) supports many different languages!<br>A list of available languages can be viewed on the Multi-Language Management (MLM) Translations Repository <a href="https://redcap.vanderbilt.edu/surveys/?__report=7LEEXCTLYA7TJDJ3" target="_blank" rel="noopener">here</a><br>Within the repository you will be able to download the ini language files for REDCap user interface translations that can be used with MLM.</p>  <p>What is MLM?! view that <a href="https://redcap.vanderbilt.edu/community/post.php?id=219388&amp;comment=219389" target="_blank" rel="noopener">here</a></p></div><br><div class="help_embedcode"></div></div>
                        </div>
                    </div><div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
