...
const ALTERNATE_PSALM_VERSION = '5.15.0';
...
class Scan
{
	...
	private function getPsalmPath(){
		if($this->shouldUsePsalmDevVersion()){
			...
			$this->verifyCleanGitRepo(exec("echo $psalmDirPath"), 'all-my-unmerged-PRs');
		...
		foreach($lines as $line){
			if(str_starts_with($line, "\t")){
				...
				if($section !== 'Changes to be committed:'){
					...
					exit("Mark, all outstanding changes in the following repo must be staged in order to run a scan: $dir\n");
				}
			}
